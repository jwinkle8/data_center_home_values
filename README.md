...
<p align="center">
  <img src="study_visualizations/charts/operational_charts_with_background.png" width="60%">
</p>
...
6. Generate the data visualization:
    ...
    ```
7. View the output of the analysis in the `study_visualizations/charts` directory.
